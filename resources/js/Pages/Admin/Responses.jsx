    ...
    return (
        <AuthenticatedLayout header="Data Responden">
            ...
            <div className="space-y-4 print:hidden">
                ...
                <div className="card">
                    <div
                        className="card-header pb-3 border-b border-slate-100"
                        style={{ padding: "16px" }}
                    >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-12 gap-3 items-end">
                            ...
                            <div className="md:col-span-4 flex gap-2">
                                <button
                                    ...
                                    className="flex-1 flex items-center justify-center gap-1.5 bg-[#405189] text-white py-[8px] rounded-sm text-[13px] font-medium hover:bg-[#3a4a7d] transition-colors"
                                >
                                    <FiFilter size={14} /> Terapkan
                                </button>
                                <button
                                    onClick={clearFilters}
                                    className="flex items-center justify-center gap-1.5 bg-white border border-slate-200 text-slate-600 py-[8px] px-3 rounded-sm text-[13px] hover:bg-slate-50 transition-colors"
                                >
                                    <FiRefreshCw size={13} />
                                </button>
                            </div>
                ...
                <div className="card">
                    <div
                        className="card-header flex items-center justify-between pb-3 border-b border-slate-100"
                        style={{ padding: "16px" }}
                    >
                        <h5 className="text-[13px] font-semibold text-slate-800">
                            Database Responden
                        ...
                        <table className="w-full">
                            <thead>
                                <tr className="border-b border-slate-100">
                                    ...
                                    <th className="px-4 py-3 text-[11px] font-semibold text-slate-500 uppercase tracking-wider text-left hidden md:table-cell">
                                        Kontak
                                    </th>
                                    <th className="px-4 py-3 text-[11px] font-semibold text-slate-500 uppercase tracking-wider text-left hidden lg:table-cell">
                                        Wilayah
                                    </th>
                                    <th className="px-4 py-3 text-[11px] font-semibold text-slate-500 uppercase tracking-wider text-center w-20">
                                        Skor
                                    </th>
                                    <th className="px-4 py-3 text-[11px] font-semibold text-slate-500 uppercase tracking-wider text-center w-28">
                                        Aksi
                                    </th>
                                </tr>
                            </thead>
                                        ...
                                        >
                                            <td className="px-4 py-3">
                                                <div className="flex items-center gap-2.5">
                                                    <div className="w-8 h-8 bg-indigo-50 rounded-sm flex items-center justify-center text-indigo-600 text-xs font-semibold shrink-0">
                                                        {r.nama
                                                            .charAt(0)
                                                            .toUpperCase()}
                                                    </div>
                                            ...
                                            <td className="px-4 py-3 hidden md:table-cell">
                                                <button
                                                    ...
                                                    className="text-[12px] text-green-600 font-medium hover:underline flex items-center gap-1"
                                                >
                                            ...
                                            <td className="px-4 py-3 text-center">
                                                <span
                                                    className={`inline-block text-[12px] font-semibold px-2 py-0.5 rounded-sm ${r.rata_rata >= 85 ? "bg-teal-50 text-teal-600" : r.rata_rata >= 70 ? "bg-indigo-50 text-indigo-600" : r.rata_rata >= 55 ? "bg-amber-50 text-amber-600" : "bg-red-50 text-red-600"}`}
                                                >
                                                    {r.rata_rata}
                                                </span>
                                            </td>
                                            <td className="px-4 py-3">
                                                <div className="flex items-center justify-center gap-0.5">
                                                    <button
                                                        ...
                                                        className="p-1.5 text-slate-400 hover:text-amber-600 hover:bg-amber-50 rounded-sm"
                                                        title="Piagam"
                                                    >
                                                        <FiAward size={14} />
                                                    </button>
                                                    <button
                                                        ...
                                                        className="p-1.5 text-slate-400 hover:text-indigo-600 hover:bg-indigo-50 rounded-sm"
                                                        title="Detail"
                                                    >
                                                        <FiEye size={14} />
                                                    </button>
                    ...
                    <div className="bg-white rounded-sm overflow-hidden">
                        <div className="px-5 py-4 border-b border-slate-200 flex justify-between items-center bg-slate-50">
                            <div className="flex items-center gap-3">
                                <div className="w-9 h-9 bg-[#405189] rounded-sm flex items-center justify-center text-white font-semibold">
                                    {selectedResponse.nama.charAt(0)}
                                </div>
                                <div>
                                    <h5 className="text-[14px] font-semibold text-slate-800">
                                        {selectedResponse.nama}
                                    </h5>
                                    <p className="text-[11px] text-slate-400">
                                        {selectedResponse.lokasi} ·{" "}
                                        {selectedResponse.no_wa}
                                    </p>
                                </div>
                            </div>
                            <button
                        ...
                        <div className="p-5 space-y-4 max-h-[70vh] overflow-y-auto">
                            <div className="grid grid-cols-2 gap-3">
                                <div className="bg-slate-50 border border-slate-100 rounded-sm p-4">
                                    <p className="text-[11px] text-slate-400 font-medium uppercase mb-1">
                                        Skor
                                    </p>
                                    <p className="text-2xl font-semibold text-slate-800">
                                        {selectedResponse.rata_rata}
                                ...
                                <div className="bg-slate-50 border border-slate-100 rounded-sm p-4">
                                    ...
                                    <p
                                        className={`text-lg font-semibold ${selectedResponse.rata_rata >= 85 ? "text-teal-600" : selectedResponse.rata_rata >= 70 ? "text-indigo-600" : selectedResponse.rata_rata >= 55 ? "text-amber-600" : "text-red-600"}`}
                                    >
                                        {selectedResponse.rata_rata >= 85
                                            ? "Sangat Puas"
                                            : selectedResponse.rata_rata >= 70
                                              ? "Puas"
                                              : selectedResponse.rata_rata >= 55
                                                ? "Cukup"
                                                : "Kurang Puas"}
                                    </p>
                                </div>
                            ...
                            <div>
                                <h6 className="text-[12px] font-semibold text-slate-600 uppercase tracking-wider mb-2">
                                    Rincian Jawaban
                                </h6>
                                                ...
                                                >
                                                    ...
                                                    <div className="flex items-center gap-2 shrink-0">
                                                        <div className="w-14 h-1 bg-slate-100 rounded-full overflow-hidden">
                                                            <div
                                                                className={`h-full rounded-full ${ans.score >= 85 ? "bg-teal-500" : ans.score >= 70 ? "bg-indigo-400" : ans.score >= 55 ? "bg-amber-400" : "bg-red-500"}`}
                                                                style={{
                                                                    width: `${ans.score}%`,
                                                                }}
                                                            />
                                                        </div>
                                                        <span className="text-[12px] font-semibold text-slate-700 w-6 text-right">
                                                            {ans.score}
                                                        </span>
                                                    </div>
                                                </div>
                            ...
                            <div className="flex gap-2 pt-2">
                                <button
                                    ...
                                    className="flex-1 flex items-center justify-center gap-1.5 bg-green-600 hover:bg-green-700 text-white py-2 rounded-sm text-[13px] font-medium transition-colors"
                                >
                                    <FiSmartphone size={14} /> WhatsApp
                                </button>
                                <button
                                    onClick={() =>
                                        openCertificate(selectedResponse)
                                    }
                                    className="flex-1 flex items-center justify-center gap-1.5 bg-amber-500 hover:bg-amber-600 text-white py-2 rounded-sm text-[13px] font-medium transition-colors"
                                >
                                    <FiAward size={14} /> Piagam
                                </button>
                            </div>
                        </div>
                    </div>
                ...
                {selectedResponse && (
                    <div className="bg-white rounded-sm overflow-hidden">
                        <div className="print:hidden p-4 border-b border-slate-200 flex justify-between items-center bg-slate-50">
                            <h5 className="text-[13px] font-semibold text-slate-800 flex items-center gap-2">
                                <FiAward className="text-amber-500" /> Preview
                                Piagam
                            </h5>
                            <div className="flex gap-2">
                                <button
                                    onClick={() => window.print()}
                                    className="flex items-center gap-1.5 bg-[#405189] text-white px-3 py-1.5 rounded-sm text-[12px] font-medium hover:bg-[#3a4a7d]"
                                >
                            ...
                            <div className="w-[800px] h-[560px] border-[12px] border-double border-slate-800 p-10 relative bg-white flex flex-col items-center justify-between text-slate-900 shrink-0">
                                <div className="flex justify-between w-full items-center pb-6 border-b border-slate-200">
                                    ...
                                    <div className="text-center">
                                        ...
                                        <p className="text-[10px] font-semibold text-amber-600 tracking-widest uppercase">
                                            Balai KB Argapura
                                        </p>
                                    </div>
                                    <img
                                        src="/Logogram-Warna.png"
                                        alt="Logo"
                                ...
                                <div className="text-center flex-1 flex flex-col justify-center gap-3">
                                    ...
                                    <p className="text-sm text-slate-500 italic">
                                        Diberikan sebagai tanda terima kasih
                                        kepada :
                                    </p>
                                    <h3 className="text-3xl font-bold uppercase tracking-tight border-b-2 border-amber-500 pb-1 inline-block mx-auto px-6">
                                        {selectedResponse.nama}
                                    </h3>
                                    <p className="max-w-lg mx-auto text-xs leading-relaxed text-slate-500 mt-2">
                                        Terima kasih atas partisipasi aktif
                                        dalam Survei Kepuasan Masyarakat Balai
                                        KB Argapura.
                                    </p>
                                </div>
