...
export default function Guest({ children }) {
    ...
    return (
        <div className="min-h-screen bg-white font-['Instrument_Sans',_sans-serif] selection:bg-amber-600 selection:text-white">
            ...
            <nav
                className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${scrolled ? "bg-white/95 backdrop-blur-xl border-b border-slate-200/80 shadow-sm" : "bg-transparent"}`}
            >
                <div className="max-w-7xl mx-auto px-6 sm:px-10">
                    <div className="flex justify-between items-center h-[72px]">
                        ...
                        <button
                            ...
                            className="lg:hidden p-2.5 bg-white rounded-lg border border-slate-200 text-slate-700 hover:bg-slate-50 transition-colors"
                        >
                            <FiMenu size={22} />
                        </button>
                    </div>
                        ...
                        >
                            <div className="flex justify-between items-center mb-10">
                                ...
                                <button
                                    ...
                                    className="p-3 bg-slate-100 rounded-2xl text-slate-600 hover:bg-rose-50 hover:text-rose-600 transition-colors"
                                >
                                    <FiX size={20} />
                                </button>
                            </div>
                            <div className="flex flex-col gap-3">
                                {navLinks.map((link) => (
                                    <a
                                        ...
                                        href={link.href}
                                        className="text-slate-700 font-semibold p-5 bg-slate-50 rounded-[2rem] hover:bg-amber-50 hover:text-amber-600 transition-all border border-transparent hover:border-amber-100"
                                    >
                                        {link.name}
                                    </a>
                                ))}
                            ...
                            <div className="mt-auto pb-10 flex flex-col gap-5">
                                <a
                                    onClick={(e) =>
                                        scrollToSection(e, "#survei")
                                    }
                                    href="#survei"
                                    className="w-full text-center bg-amber-400 text-amber-950 py-5 rounded-[2rem] font-bold shadow-xl shadow-amber-400/20 uppercase tracking-widest text-sm"
                                >
                                    Mulai Isi Survei
                                </a>
                            </div>
            ...
            <footer
                className="bg-slate-50 border-t border-slate-100 relative overflow-hidden"
                id="kontak"
            >
                ...
                <div className="max-w-7xl mx-auto px-8 sm:px-10 lg:px-12 py-24 relative z-10">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
                        <div className="lg:col-span-1">
                            ...
                            <p className="text-slate-500 text-sm leading-relaxed mb-8 font-medium">
                                Lembaga terpercaya dalam mewujudkan keluarga
                                sehat, berencana, dan berkualitas melalui
                                pendampingan siklus hidup manusia.
                            </p>
                        </div>

                        <div>
                            <h4 className="font-bold text-slate-900 text-sm uppercase tracking-widest mb-8 border-l-4 border-amber-400 pl-4">
                                Akses Layanan
                            </h4>
                            <ul className="space-y-4 font-semibold text-slate-500 text-sm">
                                <li>
                                    <a
                                        href="#layanan"
                                        onClick={(e) =>
                                            scrollToSection(e, "#layanan")
                                        }
                                        className="hover:text-amber-600 hover:translate-x-1 inline-flex transition-all"
                                    >
                                        Layanan Unggulan
                                    </a>
                                </li>
                    ...
                    <div className="pt-10 border-t border-slate-200 text-center flex flex-col md:flex-row justify-between items-center gap-6">
                        <p className="text-xs font-bold text-slate-400">
                            © 2026 Badan Kependudukan dan Keluarga Berencana
                            Nasional. Seluruh layanan gratis.
                        </p>
                        <div className="flex items-center gap-6">
                            <div className="flex items-center gap-3">
                                ...
                                <a
                                    href="https://www.instagram.com/balaikb.argapura"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="w-8 h-8 rounded-lg bg-amber-50 border border-amber-100 flex items-center justify-center text-amber-600 hover:bg-amber-600 hover:text-white transition-all shadow-sm"
                                >
                                    <FiInstagram size={16} />
                                </a>
                            </div>
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div className="flex gap-2">
                                    <div className="w-8 h-8 rounded-lg bg-amber-50 border border-amber-100 flex items-center justify-center text-[10px] font-black text-amber-600">
                                        ISO
                                    </div>
                                    <div className="w-8 h-8 rounded-lg bg-amber-50 border border-amber-100 flex items-center justify-center text-[10px] font-black text-amber-600">
                                        WTP
